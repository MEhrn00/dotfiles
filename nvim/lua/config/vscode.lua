...
end, { desc = "Move to next quickfix list entry", silent = true })

map("n", "[q", function()
  vscode.action("editor.action.marker.prev")
end, { desc = "Move to previous quickfix list entry", silent = true })
...
end, { desc = "Run build task", silent = true })
...
end, { desc = "Grep for text", silent = true })
...
end, { desc = "Find LSP references", silent = true })

map("n", "<leader>fs", function()
  vscode.action("workbench.action.showAllSymbols")
end, { desc = "Find LSP workspace symbols", silent = true })

-- Git
map("n", "<leader>gd", function()
  vscode.action("gitlens.openFileHistory")
end, { desc = "Git open file history", silent = true })

map("n", "<leader>gb", function()
  vscode.action("git.checkout")
end, { desc = "Git checkout branch/tag", silent = true })

map("n", "<leader>gg", function()
  vscode.action("workbench.view.scm")
end, { desc = "Open Git status", silent = true })
...
end, { desc = "Display signature help", silent = true})

map("n", "crn", function()
  vscode.action("editor.action.rename")
end, { desc = "Rename symbol", silent = true })

map("n", "ga", function()
  vscode.action("editor.action.quickFix")
end, { desc = "Select code action", silent = true})

map("n", "]d", function()
  vscode.action("editor.action.marker.nextInFiles")
end, { desc = "Go to next LSP diagnostic", silent = true })

map("n", "[d", function()
  vscode.action("editor.action.marker.prevInFiles")
end, { desc = "Go to previous LSP diagnostic", silent = true })
